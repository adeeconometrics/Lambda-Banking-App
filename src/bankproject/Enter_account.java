 ...
 * @author A.A. Yapan
 */
public class Enter_account extends javax.swing.JFrame {

    /**
     * Creates new form Enter_admin_account
     */
    public Enter_account() {
        super("An account needed");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("account to login");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Enter_account.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Enter_account().setVisible(true);
            }
        });
    }
