 ...
 * @author A.A. Yapan
 */
public class Withdraw_window extends javax.swing.JFrame {
    ...
    public Withdraw_window(String x, String y) {
        username = x;
        password = y;
        initComponents();
    }
    ...
    private void submit_ButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_submit_ButtonMouseClicked
       ...
       try {
            ...
            user.withdraw(st, val);
            
            receiptInfo ri = user.getReceipt(val, st);
            
            Reciept_window receipt = new Reciept_window(ri, 1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Withdraw_window.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Withdraw_window(username, password).setVisible(true);
            }
        });
    }
