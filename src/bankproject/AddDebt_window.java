 ...
 * @author A.A. Yapan
 */
public class AddDebt_window extends javax.swing.JFrame {
    ...
    public AddDebt_window(String x, String y) {
        username = x;
        password = y;
        initComponents();
    }
    ...
    private void submit_ButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_submit_ButtonMouseClicked
       ...
       try {
            ...
            Reciept_window receipt = new Reciept_window(ri, 5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddDebt_window.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddDebt_window(username, password).setVisible(true);
            }
        });
    }
